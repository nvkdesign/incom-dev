set :application, "incom"
set :domain, "root@vps237233.ovh.net" # Le SSH de destination
set :deploy_to, "/var/www/dev.incomesport.com/web/" # Le répertoire de destination
set :app_path, "app" # Le dossier d’application, laissez app
set :user, "nvkhq" # Le nom d’utilisateur du serveur distant

set :repository, "git@github.com:nvkdesign/incom-dev.git" # L’URL de votre repository
